...
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/vscode-nautilus.py https://raw.githubusercontent.com/haroon-mahmood-4276/OpenWithNautilus/main/vscode-nautilus.py
