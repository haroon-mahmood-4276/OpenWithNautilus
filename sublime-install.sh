...
rm -f ~/.local/share/nautilus-python/extensions/SublimeExtension.py
rm -f ~/.local/share/nautilus-python/extensions/sublime-nautilus.py

# Download and install the extension
echo "Downloading newest version..."
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/sublime-nautilus.py https://raw.githubusercontent.com/haroon-mahmood-4276/OpenWithNautilus/main/sublime-nautilus.py
