...
rm -f ~/.local/share/nautilus-python/extensions/ZedExtension.py
rm -f ~/.local/share/nautilus-python/extensions/zed-nautilus.py

# Download and install the extension
echo "Downloading newest version..."
wget --show-progress -q -O ~/.local/share/nautilus-python/extensions/zed-nautilus.py https://raw.githubusercontent.com/haroon-mahmood-4276/OpenWithNautilus/main/zed-nautilus.py
